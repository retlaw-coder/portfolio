...
if (document.body.classList.contains('project-page')) {
    ...
    const projectData = {
        ...
        3: { title: "Nike Lab", desc: "Motion graphics y simulación de producto.", stack: ["Simulation", "Motion"], imgs: ["assets/proyecto3.png"], vids: ["assets/proyecto3.mp4"] },
        4: { title: "Proyecto 4", desc: "Descripción Proyecto 4", stack: ["Blender", "Cycles"], imgs: ["assets/proyecto4.png"], vids: ["assets/proyecto4.mp4"] },
        5: { title: "Proyecto 5", desc: "Descripción Proyecto 5", stack: ["Blender", "Cycles"], imgs: ["assets/proyecto5_0.png", "assets/proyecto5_1.png", "assets/proyecto5_0.png", "assets/proyecto5_1.png"], vids: [] },
